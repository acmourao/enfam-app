CREATE DATABASE  IF NOT EXISTS `educaenfam` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `educaenfam`;
-- MySQL dump 10.13  Distrib 5.7.17, for Win64 (x86_64)
--
-- Host: SVLP-BDENFAM-01    Database: educaenfam
-- ------------------------------------------------------
...
CREATE TABLE `aeroportos` (
  ...
  `aeroporto` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `andamentos` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `credenciamento_id` int(10) unsigned DEFAULT NULL,
  `tipo_andamento_id` int(10) unsigned NOT NULL,
  `usuario_id` int(10) unsigned DEFAULT NULL,
  `data` datetime NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `mensagem` varchar(6000) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Mensagem redigida pelo usuário que gerou o andamento',
  `projeto_id` int(10) unsigned DEFAULT NULL,
  PRIMARY KEY (`id`),
...
) ENGINE=InnoDB AUTO_INCREMENT=48686 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `anexos_credenciamento` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `credenciamento_id` int(10) unsigned NOT NULL,
  `tipo_id` int(10) unsigned NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `data_publicacao` datetime DEFAULT NULL COMMENT 'Data em que o anexo foi publicado.',
  `visibilidade` char(1) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'P' COMMENT 'Visibilidade Restrita/apenas ENFAM, ou Publica',
  `anexo_fluxo_id` int(10) unsigned DEFAULT NULL,
  PRIMARY KEY (`id`),
...
) ENGINE=InnoDB AUTO_INCREMENT=25026 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `anexos_demandas_projetos` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `demanda_projeto_id` int(10) unsigned NOT NULL,
  `tipo_anexo_projeto_id` int(10) unsigned NOT NULL,
  `anexado_por` int(10) unsigned NOT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=3858 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `anexos_evento` (
  ...
  `nome` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `url` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `visibilidade` char(1) COLLATE utf8_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `anexos_fluxos` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `fluxo` char(1) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'C',
  `anexado_por` int(10) unsigned NOT NULL,
  `nome` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `url` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `ativo` char(1) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'Y',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `anexos_projetos` (
  ...
  `tipo_anexo_projeto_id` int(10) unsigned NOT NULL,
  `anexo_fluxo_id` int(10) unsigned NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
) ENGINE=InnoDB AUTO_INCREMENT=7547 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `anexos_reconhecimento` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `reconhecimento_id` int(10) unsigned NOT NULL,
  `tipo` char(1) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Programação e Outros',
  `anexado_por` int(10) unsigned NOT NULL,
  `nome` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `url` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=10684 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `atuacao_escola_eventos` (
  ...
  `formulario_inscricao_escola_id` int(10) unsigned NOT NULL,
...
CREATE TABLE `bloqueios_inscricao` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `usuario_bloqueado_id` int(10) unsigned NOT NULL,
  `bloqueado_por_usuario_id` int(10) unsigned NOT NULL,
  `justificativa` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `inicio` date NOT NULL,
  `fim` date NOT NULL,
  `desbloqueado_por_usuario_id` int(10) unsigned DEFAULT NULL,
  `data_desbloqueio` datetime DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `justificativa_desbloqueio` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `categorias_profissionais` (
  ...
  `exige_tribunal` char(1) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'N',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `cidades` (
  ...
  `codigo` varchar(7) COLLATE utf8_unicode_ci NOT NULL,
  `estado_id` int(11) NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `tem_aeroporto` char(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'N',
  PRIMARY KEY (`id`),
  KEY `cidades_tem_aeroporto_index` (`tem_aeroporto`)
) ENGINE=InnoDB AUTO_INCREMENT=5610 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `compartilhamentos_ead` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `escola_id` int(10) unsigned NOT NULL,
  `cursos_ead_id` int(10) unsigned NOT NULL,
  `usuario_id` int(10) unsigned NOT NULL,
  `compartilhado` char(1) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'N',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `convites` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `situacao` char(1) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'N',
  `token` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `data_validade` timestamp NULL DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2707 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `credenciamentos` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `nome` varchar(600) COLLATE utf8_unicode_ci NOT NULL,
  `natureza` char(1) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Formacao inicial, continuada, etc.',
  `modalidade` char(1) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Presencial, Semipresencial e EaD',
  `carga_horaria` int(10) unsigned DEFAULT NULL,
  `vagas_por_turma` int(10) unsigned DEFAULT NULL,
  ...
  `numero_protocolo` int(10) unsigned DEFAULT NULL,
  `ano_protocolo` int(10) unsigned DEFAULT NULL,
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `justificativa` varchar(6000) COLLATE utf8_unicode_ci DEFAULT NULL,
  `intempestivo` char(1) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'N',
  `situacao` char(1) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'P' COMMENT 'Indica o posicionamento do parecerista em relação ao Credenciamento: Pendente, Deferido, Indeferido',
  `data_primeira_publicacao` datetime DEFAULT NULL COMMENT 'Data em que a primeira portaria foi publicada.',
  `credenciamento_original_id` int(10) unsigned DEFAULT NULL,
  `inicio_fiscalizacao` date DEFAULT NULL,
  `fim_fiscalizacao` date DEFAULT NULL,
  `resultado_fiscalizacao` char(1) COLLATE utf8_unicode_ci DEFAULT NULL,
  `usuario_fiscalizacao_id` int(10) unsigned DEFAULT NULL,
  `nivel` char(2) COLLATE utf8_unicode_ci DEFAULT NULL,
  `qtd_docentes` int(10) unsigned DEFAULT NULL,
  `alteracoes` varchar(6000) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
) ENGINE=InnoDB AUTO_INCREMENT=4663 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `cursos_ead` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `categoria` char(1) COLLATE utf8_unicode_ci DEFAULT NULL,
  `nivel` char(2) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `demandas_projetos` (
  ...
  `tipo` char(1) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Curso, oficina, etc',
  `categoria` char(1) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'formacao Inicial, formacao Continuada, formacao de Formadores',
  `nivel` char(2) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Nivel/equivalencia',
  `modalidade` char(1) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Presencial, Semi presencial ou Ead',
  `uf` char(2) COLLATE utf8_unicode_ci DEFAULT NULL,
  `cidade_id` int(10) unsigned DEFAULT NULL,
...
CREATE TABLE `deslocamentos` (
  ...
  `usuario_id` int(10) unsigned NOT NULL,
  `evento_id` int(10) unsigned NOT NULL,
  `aeroporto_origem_id` int(10) unsigned DEFAULT NULL COMMENT 'Nullable pois nao necessariamente ha emissao de passagem',
  `aeroporto_retorno_id` int(10) unsigned DEFAULT NULL COMMENT 'Nullable pois nao necessariamente ha emissao de passagem',
  ...
  `bagagem` char(1) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'M  - De mão, D - Despachada. Nullable pois nao necessariamente ha emissao de passagem',
  `justificativa` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Utilizado para compor a RPD enviada ao SEI',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `emite_passagem` char(1) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'Y' COMMENT 'Indica se este deslocamento tera emissao de passagens',
  `banco_id` int(10) unsigned DEFAULT NULL,
  `agencia` varchar(30) COLLATE utf8_unicode_ci DEFAULT NULL,
  `conta_corrente` varchar(30) COLLATE utf8_unicode_ci DEFAULT NULL,
  `cargo` varchar(1) COLLATE utf8_unicode_ci DEFAULT 'M' COMMENT 'Ministro, Desembargador, Juiz, Servidor - Analista ou CJ(A), Servidor - Técnico ou FC(T), Outros',
  `equivalencia` varchar(1) COLLATE utf8_unicode_ci DEFAULT 'J' COMMENT 'Apenas utilizado para o cargo Outros',
  `cargo_outro` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Texto livre para informar o cargo no caso de ser Outros',
  PRIMARY KEY (`id`),
...
CREATE TABLE `docentes` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `usuario_id` int(10) unsigned NOT NULL,
  `titulacao` char(1) COLLATE utf8_unicode_ci NOT NULL,
  `mini_curriculo` text COLLATE utf8_unicode_ci,
  `url` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `escola_id` int(10) unsigned DEFAULT NULL,
  `formador` char(1) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'N',
  `formador_enfam` char(1) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'N',
  `complementado` char(1) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'N',
  `autoriza_divulgacao` char(1) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'N' COMMENT 'Autoriza participar do banco nacional de formadores',
  `autoriza_presencial` char(1) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'N' COMMENT 'Só pode autorizar se tiver competencia para ser formador presencial',
  `autoriza_tutoria` char(1) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'N' COMMENT 'Só pode autorizar se tiver competencia de tutoria',
  `autoriza_conteudista` char(1) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'N' COMMENT 'Só pode autorizar se tiver competencia de conteudista',
  `competencia_presencial` char(1) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'N' COMMENT 'Calculado pelo sistema. Indica se tem competencia para ser formador presencial',
  `competencia_tutoria` char(1) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'N' COMMENT 'Calculado pelo sistema. Indica se tem competencia para ser tutor',
  `competencia_conteudista` char(1) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'N' COMMENT 'Calculado pelo sistema. Indica se tem competencia para ser conteudista',
  `competencia_gestor` char(1) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'N' COMMENT 'Indica se o formador tem competencia para atuar como gestor',
  `autoriza_gestor` char(1) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'N' COMMENT 'Indica se o formador autorizou sua participacao como gestor no BNF',
  ...
  `especialista_fofo` char(1) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'N',
  PRIMARY KEY (`id`),
...
) ENGINE=InnoDB AUTO_INCREMENT=9478 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `docentes_credenciamento` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `participacao` char(1) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'D' COMMENT 'Indica se é um Docente ou Coordenador pedagógico',
  PRIMARY KEY (`id`),
...
) ENGINE=InnoDB AUTO_INCREMENT=47520 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `docentes_projetos` (
  ...
  `projeto_id` int(10) unsigned NOT NULL,
  `docente_id` int(10) unsigned NOT NULL,
  `participacao` char(1) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Coordenador pedagogico, Docente',
  `carga_horaria` decimal(6,2) NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `orientado` char(1) COLLATE utf8_unicode_ci DEFAULT NULL,
  `avaliado` char(1) COLLATE utf8_unicode_ci DEFAULT NULL,
  `ativo` tinyint(1) NOT NULL DEFAULT '1',
  `perfil_pedagogico_id` int(10) unsigned DEFAULT NULL COMMENT 'Nullable para ter compatibilidade com projetos de curso já criados',
  `voluntario` tinyint(1) NOT NULL DEFAULT '0',
  `convite_id` int(10) unsigned DEFAULT NULL,
  PRIMARY KEY (`id`),
...
) ENGINE=InnoDB AUTO_INCREMENT=59509 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=29864 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `equipes_eventos` (
  ...
  `usuario_id` int(10) unsigned NOT NULL,
  `evento_id` int(10) unsigned NOT NULL,
  `funcao` char(1) COLLATE utf8_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `de` date DEFAULT NULL,
  `ate` date DEFAULT NULL,
  `carga_horaria` varchar(10) COLLATE utf8_unicode_ci DEFAULT NULL,
  `designacao` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `emite_certificado` tinyint(1) DEFAULT NULL,
  `avaliado` tinyint(1) DEFAULT NULL,
  `orientado` char(1) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'N' COMMENT 'Indica se o participante deve ser orientado, o que possibilita o envio de um arquivo com orientacoes ao membro da equipe',
  `voluntario` tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
...
) ENGINE=InnoDB AUTO_INCREMENT=8214 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `escolas` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `sigla` varchar(15) COLLATE utf8_unicode_ci DEFAULT NULL,
  `tipo` char(1) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'V',
  ...
  `nome_diretor` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `cargo_diretor` varchar(120) COLLATE utf8_unicode_ci DEFAULT NULL,
  `sexo_diretor` char(1) COLLATE utf8_unicode_ci DEFAULT NULL,
  `mandato_de` date DEFAULT NULL,
  `mandato_ate` date DEFAULT NULL,
  `ativa` char(1) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'Y',
  `tribunal_id` int(10) unsigned DEFAULT NULL,
  `nome_responsavel_tecnico` varchar(120) COLLATE utf8_unicode_ci DEFAULT NULL,
  `telefones_responsavel_tecnico` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `imagem_bg` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Imagem de fundo da Escola para permitir customizacao do educa enfam',
  `url_logo` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `eventos` (
  ...
  `inicio` date NOT NULL,
  `fim` date NOT NULL,
  `carga_horaria` varchar(10) COLLATE utf8_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `frequencia_minima` int(11) NOT NULL,
  `uf` char(2) COLLATE utf8_unicode_ci DEFAULT NULL,
  `cidade_id` int(10) unsigned DEFAULT NULL,
  ...
  `escola_id` int(10) unsigned DEFAULT NULL,
  `docente_template_id` int(10) unsigned DEFAULT NULL,
  `categoria` char(1) COLLATE utf8_unicode_ci DEFAULT NULL,
  `avaliacao_reacao_id` int(10) unsigned DEFAULT NULL,
  `avaliacao_docente_id` int(10) unsigned DEFAULT NULL,
  `legado` char(1) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'N' COMMENT 'Indica se o evento ocorreu em datas anteriores à entrada do sistema em produção',
  `nivel` char(2) COLLATE utf8_unicode_ci DEFAULT NULL,
  `modalidade` char(1) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'P',
  `docente_convidado_template_id` int(10) unsigned DEFAULT NULL,
  `computa_meta_fisica` char(1) COLLATE utf8_unicode_ci DEFAULT NULL,
  `credenciamento_id` int(10) unsigned DEFAULT NULL,
  `template_email_confirmacao_inscricao_id` int(10) unsigned DEFAULT NULL,
  `tolerancia_cancelamento` date NOT NULL,
  `template_email_lembrete_inscricao_id` int(10) unsigned DEFAULT NULL,
  `template_email_cancel_inscricao_id` int(10) unsigned DEFAULT NULL,
  `emissao_passagem_alunos` char(1) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'N',
  `template_email_notificacao_conclusao_id` int(10) unsigned DEFAULT NULL,
  `atendimento_diferenciado` char(1) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'N',
  `novo` char(1) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'N',
  `projeto_id` int(10) unsigned DEFAULT NULL,
  `inicio_registro_atividade` date DEFAULT NULL,
  `controle_aprovacao` char(1) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'A  - Automático (Moodle), M - Manual. Nullable para Modalidades diferentes de EaD',
  `template_email_inclusao_fila_espera_id` int(10) unsigned DEFAULT NULL,
  `cursos_ead_id` int(10) unsigned DEFAULT NULL,
  PRIMARY KEY (`id`),
...
) ENGINE=InnoDB AUTO_INCREMENT=6247 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `formulario_inscricao` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `evento_id` int(10) unsigned NOT NULL,
  `ativo` char(1) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'N',
  `vagas` int(10) unsigned DEFAULT NULL,
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `cor_fundo` char(7) COLLATE utf8_unicode_ci NOT NULL DEFAULT '#ffffff',
  `lista_espera` char(1) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'N',
  `somente_magistrados` char(1) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'N',
  `emissao_passagens` char(1) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'N' COMMENT 'Indica se o formulario disponibiliza campos para emissao de passagens',
  PRIMARY KEY (`id`),
...
CREATE TABLE `formulario_inscricao_escolas` (
  ...
  `disponivel_de` date DEFAULT NULL,
  `disponivel_ate` date DEFAULT NULL,
  `orientacoes` varchar(600) COLLATE utf8_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `frequencias` (
  ...
  `periodo_evento_id` int(10) unsigned NOT NULL,
  `registrado_por` int(10) unsigned NOT NULL,
  `registrado_em` datetime NOT NULL,
  `situacao` char(1) COLLATE utf8_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `motivo` char(1) COLLATE utf8_unicode_ci DEFAULT NULL,
  `justificativa` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
) ENGINE=InnoDB AUTO_INCREMENT=484250 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `historicos_anexos_fluxos` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `justificativa` varchar(6000) COLLATE utf8_unicode_ci NOT NULL,
  `operacao` char(1) COLLATE utf8_unicode_ci NOT NULL,
  `usuario_id` int(10) unsigned NOT NULL,
  `anexo_id` int(10) unsigned NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `inscricao_avaliacao_resposta` (
  ...
  `resposta` longtext COLLATE utf8_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `inscricao_motivos_cancelamento` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `outro_motivo` varchar(1000) COLLATE utf8_unicode_ci DEFAULT NULL,
  `inscricao_id` int(10) unsigned DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=17897 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `inscricoes` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `situacao` char(1) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'I',
  `criado_por` int(10) unsigned NOT NULL,
  `origem` char(1) COLLATE utf8_unicode_ci DEFAULT NULL,
  `escola_id` int(10) unsigned DEFAULT NULL,
  `email_enviado` tinyint(1) NOT NULL DEFAULT '0',
  `evento_escola_id` int(10) unsigned DEFAULT NULL,
  `tipo_participacao` char(1) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'A',
  `avaliacao_respondida` char(1) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'N',
  `lead_id` int(10) unsigned DEFAULT NULL,
  `ativo` char(1) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'Y',
  `atendimento_diferenciado` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `cota_acao_afirmativa` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `forma_participacao` char(1) COLLATE utf8_unicode_ci DEFAULT NULL,
  `ano_certificado` int(11) DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=386524 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=24767 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `lista_espera_publica` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `formulario_inscricao_id` int(10) unsigned NOT NULL,
  ...
  `situacao` char(1) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'E',
  `data_situacao` datetime NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `tipo_deficiencia` char(1) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Informação vinculada ao usuário',
  `atendimento_diferenciado` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Vinculada à inscrição',
  `autodeclarado` char(1) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Informação vinculada ao usuário',
  `cota_acao_afirmativa` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Vinculada à inscrição',
  `forma_participacao` char(1) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
) ENGINE=InnoDB AUTO_INCREMENT=33204 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=2864426 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=196070 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=8544 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `log_frequencias` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `erro` varchar(600) COLLATE utf8_unicode_ci NOT NULL,
  `json_frequencia` text COLLATE utf8_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9844 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `lote_documentos_sei` (
  ...
  `nome` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `evento_id` int(10) unsigned NOT NULL,
  `numero_processo_sei` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `id_processo_sei` int(11) NOT NULL,
  `iniciado_em` datetime DEFAULT NULL,
  `finalizado_em` datetime DEFAULT NULL,
  `qtd_itens_total` int(11) NOT NULL DEFAULT '0',
  `qtd_itens_enviados` int(11) NOT NULL DEFAULT '0',
  `tipo_documento_sei` char(1) COLLATE utf8_unicode_ci NOT NULL,
  `situacao` char(1) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'N',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `mensagens` text COLLATE utf8_unicode_ci COMMENT 'Guarda as mensagens de erro dos itens do lote',
  `proponente` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `magistrados_receita` (
  ...
  `nome_mae` text,
  `natureza_ocupacao_id` int(11) DEFAULT NULL,
  `ocupacao_principal_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`cpf`)
...
CREATE TABLE `mandato_escolas` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `nome_diretor` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `cargo_diretor` varchar(120) COLLATE utf8_unicode_ci NOT NULL,
  `sexo_diretor` char(1) COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE `mensagens_replicacao` (
  ...
  `replicacao_id` int(10) unsigned NOT NULL,
  `mensagem` varchar(600) COLLATE utf8_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `model_history` (
  ...
  `tabela` varchar(40) COLLATE utf8_unicode_ci NOT NULL,
  `alteracao` text COLLATE utf8_unicode_ci NOT NULL,
  `alterado_por` int(10) unsigned NOT NULL,
  `rota` varchar(120) COLLATE utf8_unicode_ci NOT NULL,
  `ip_usuario` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `action` enum('C','U','D') COLLATE utf8_unicode_ci NOT NULL DEFAULT 'C',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3537720 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `motivos_cancelamento` (
  ...
  `padrao` char(1) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'N',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `lote` char(1) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'N',
  PRIMARY KEY (`id`)
...
CREATE TABLE `notificacoes_andamentos` (
  ...
  `andamento_id` int(10) unsigned DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
) ENGINE=InnoDB AUTO_INCREMENT=38384 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=436296 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `numeros_portaria` (
  ...
  `situacao` char(1) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'P',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `numeros_portaria_reconhecimento` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `reconhecimento_id` int(10) unsigned DEFAULT NULL,
  `anexo_id` int(10) unsigned DEFAULT NULL,
  `numero` int(10) unsigned NOT NULL,
  `ano` int(10) unsigned NOT NULL,
  `situacao` char(1) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'P',
...
CREATE TABLE `parametros` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `chave` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=18428 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `periodos_evento` (
  ...
  `tolerancia_minima` int(11) NOT NULL DEFAULT '15',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `tolerancia_maxima` int(11) NOT NULL DEFAULT '15',
  `nome` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
...
) ENGINE=InnoDB AUTO_INCREMENT=40723 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `portarias_compartilhamento_ead` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `compartilhamento_ead_id` int(10) unsigned NOT NULL,
  ...
  `portaria_compartilhamento` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `url_portaria` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `previsoes_orcamentarias_projetos` (
  ...
  `ativo` tinyint(1) NOT NULL DEFAULT '1',
  `descricao_outro` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Para o usuario especificar o tipo quando selecionar Outro',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `docente_projeto_id` int(10) unsigned DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `projetos` (
  ...
  `demanda_projeto_id` int(10) unsigned NOT NULL,
  `titulo` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `vagas` smallint(5) unsigned DEFAULT NULL COMMENT 'Quantidade de vagas',
  `carga_horaria` decimal(6,2) DEFAULT NULL,
  `frequencia_minima` tinyint(3) unsigned DEFAULT NULL,
  `tipo` char(1) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Curso, oficina, etc',
  `categoria` char(1) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'formacao Inicial, formacao Continuada, formacao de Formadores',
  `nivel` char(2) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Nivel/equivalencia',
  `modalidade` char(1) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Presencial, Semi presencial ou Ead',
  `uf` char(2) COLLATE utf8_unicode_ci DEFAULT NULL,
  `cidade_id` int(10) unsigned DEFAULT NULL,
  `endereco` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `objetivo_geral` text COLLATE utf8_unicode_ci NOT NULL,
  `objetivo_especifico` text COLLATE utf8_unicode_ci,
  `metodologia` text COLLATE utf8_unicode_ci,
  `justificativa` text COLLATE utf8_unicode_ci,
  `atribuicoes_formador` text COLLATE utf8_unicode_ci,
  `sistema_avaliacao` text COLLATE utf8_unicode_ci,
  `parcerias` text COLLATE utf8_unicode_ci,
  `observacoes` text COLLATE utf8_unicode_ci,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `ultimo_andamento` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Para facilitar a exibicao da situacao atual do projeto',
  `computa_meta_fisica` char(1) COLLATE utf8_unicode_ci DEFAULT NULL,
  `curso_novo` char(1) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Utilizado no indicador 14 - cursos novos',
  `emissao_passagem_alunos` char(1) COLLATE utf8_unicode_ci DEFAULT NULL,
  `inicio` date DEFAULT NULL,
  `fim` date DEFAULT NULL,
  ...
  `numero_sei` varchar(10) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Número do processo no SEI, obrigatório na assinatura',
  `orientacoes_elaboracao` text COLLATE utf8_unicode_ci,
  PRIMARY KEY (`id`),
...
CREATE TABLE `propostas` (
  ...
  `tipo_curso_id` int(10) unsigned NOT NULL,
  `nome` varchar(150) COLLATE utf8_unicode_ci NOT NULL,
  `previsao_inicio` date NOT NULL,
  `carga_horaria` int(11) NOT NULL,
  `finalidade` char(1) COLLATE utf8_unicode_ci DEFAULT NULL,
  `modalidade` char(1) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'P',
  `vagas` int(11) NOT NULL,
  `cessao_vagas` char(1) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'N',
  `vagas_cedidas` int(11) DEFAULT NULL,
...
CREATE TABLE `publico_alvo_demanda` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `demanda_id` int(10) unsigned NOT NULL,
  `opcao_id` tinyint(3) unsigned NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `questionario_questoes` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `obrigatorio` char(255) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
...
) ENGINE=InnoDB AUTO_INCREMENT=1810 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `questionario_respostas` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `resposta_string` varchar(6000) COLLATE utf8_unicode_ci DEFAULT NULL,
  `resposta_int` tinyint(4) DEFAULT NULL,
  ...
  `diario` char(1) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'N',
  PRIMARY KEY (`id`),
...
) ENGINE=InnoDB AUTO_INCREMENT=842927 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `reconhecimentos` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `situacao` char(1) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'A',
  PRIMARY KEY (`id`),
...
CREATE TABLE `regras_remuneracao_docentes` (
  `id` tinyint(3) unsigned NOT NULL AUTO_INCREMENT,
  `titulacao` char(1) COLLATE utf8_unicode_ci NOT NULL,
  `perfil_pedagogico_id` int(10) unsigned NOT NULL,
  `remuneracao` int(11) NOT NULL COMMENT 'Valor da remuneracao, em centavos',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `replicacoes_credenciamento` (
  ...
  `inicio` date NOT NULL,
  `fim` date NOT NULL,
  `observacao` varchar(600) COLLATE utf8_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `nova_replicacao` varchar(1) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'N',
  `aprovacao` char(1) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
) ENGINE=InnoDB AUTO_INCREMENT=2690 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `rpds` (
  ...
  `usuario_id` int(10) unsigned NOT NULL,
  `situacao` char(1) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'N',
  `id_documento_sei` int(11) DEFAULT NULL,
  `url_documento_sei` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `mensagem_retorno` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `processado_em` datetime DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deslocamento_id` int(10) unsigned DEFAULT NULL,
  `funcao` char(1) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `tarefas` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `nome` varchar(255) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Nome único da tarefa',
  `rota` varchar(255) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Local do arquivo que implementa a tarefa',
  `ordem` int(11) NOT NULL DEFAULT '1' COMMENT 'Utilizado para ordenar a tarefa em listas',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `tipo` char(1) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'P',
  `fluxo` char(1) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'C',
...
CREATE TABLE `tarefas_credenciamento` (
  ...
  `anotacao` text COLLATE utf8_unicode_ci COMMENT 'Anotações para uma determinada tarefa',
  PRIMARY KEY (`id`),
...
) ENGINE=InnoDB AUTO_INCREMENT=32589 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `temas` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `tema_pai_id` int(10) unsigned DEFAULT NULL,
  `nome` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `aceita_outros` char(1) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'N',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `templates_certificado` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `cor` char(7) COLLATE utf8_unicode_ci NOT NULL,
  `altura_footer` int(11) NOT NULL,
  `altura_texto` int(11) NOT NULL,
  `altura_local` int(11) NOT NULL,
  `nome` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `texto` varchar(6000) COLLATE utf8_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `escola_id` int(10) unsigned DEFAULT NULL,
  `margem_esquerda` int(10) unsigned NOT NULL DEFAULT '20',
  `margem_direita` int(10) unsigned NOT NULL DEFAULT '20',
  `ativo` char(1) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'Y',
  PRIMARY KEY (`id`),
...
CREATE TABLE `templates_email` (
  ...
  `assinatura` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `tipo` char(1) COLLATE utf8_unicode_ci NOT NULL,
  `envia_credenciais` char(1) COLLATE utf8_unicode_ci DEFAULT NULL,
  `escola_id` int(10) unsigned DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `de` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Nome que aparece como remetente da mensagem',
  `responder_para` varchar(120) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'E-mail que receberá as respostas às mensagens enviadas',
  PRIMARY KEY (`id`),
...
CREATE TABLE `tipos_andamento` (
  ...
  `visibilidade` char(1) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'E' COMMENT 'Externa/Interna. Andamentos internos só são visíveis para pessoas da ENFAM',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `fluxo` char(1) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'C',
  PRIMARY KEY (`id`)
...
CREATE TABLE `tipos_anexo_credenciamento` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `nome` varchar(120) COLLATE utf8_unicode_ci NOT NULL,
  `extensoes_aceitas` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `tipos_anexo_docente` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `exige_evento` char(1) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'N' COMMENT 'Indica se, ao anexar um documento deste tipo, é obrigatório selecionar um evento',
  `permissao` varchar(60) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Permissão necessária para anexar documentos deste tipo',
  PRIMARY KEY (`id`)
...
CREATE TABLE `tipos_previsao_orcamentaria` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `valor_padrao` int(11) DEFAULT NULL COMMENT 'Valor padrão para o tipo, em centavos',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `transicoes` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `tarefa_origem_id` int(10) unsigned DEFAULT NULL,
  `tarefa_destino_id` int(10) unsigned NOT NULL,
  `tipo_andamento_id` int(10) unsigned NOT NULL,
  `titulo` varchar(120) COLLATE utf8_unicode_ci NOT NULL,
  `regras` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Regras para que a transição ocorra. São nomes de métodos da classe FluxoCredenciamentoManager, separados por virgula. Estes métodos serão chamados quando o usuário efetuar a transição.',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `notificacoes` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `rota` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Local do arquivo que implementa a tela da transição.',
  `tipos_anexos` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Lista de ids de tipos de anexos de credenciamento, separados por vírgula. Ex: 1,2,3',
  `automatica` char(1) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'N' COMMENT 'Indica se é uma transicao automática, executada somente pelo sistema após alguma condição',
  `prazo` int(11) DEFAULT NULL COMMENT 'Prazo para transição automática da próxima tarefa.',
...
CREATE TABLE `tribunais` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `ramo` char(1) COLLATE utf8_unicode_ci NOT NULL,
  `nome` varchar(120) COLLATE utf8_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `uf` varchar(2) COLLATE utf8_unicode_ci DEFAULT NULL,
  `regiao` varchar(2) COLLATE utf8_unicode_ci DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=5702 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `usuarios` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `nome` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `cpf` varchar(120) COLLATE utf8_unicode_ci NOT NULL,
  `email` varchar(120) COLLATE utf8_unicode_ci NOT NULL,
  ...
  `categoria_id` int(10) unsigned DEFAULT NULL,
  `tribunal_id` int(10) unsigned DEFAULT NULL,
  `cadastro_completo` char(1) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'N',
  `magistrado_confirmado` char(1) COLLATE utf8_unicode_ci DEFAULT NULL,
  `magistrado_confirmado_por` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `estrangeiro` char(1) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'N',
  `tipo_deficiencia` char(1) COLLATE utf8_unicode_ci DEFAULT NULL,
  `cargo_equivalente` char(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `aposentado` char(1) COLLATE utf8_unicode_ci DEFAULT 'N',
  `cargo` char(1) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Ministro, Desembargador, Juiz, Analista, Tecnico, Outros',
  `titulacao` char(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `autodeclarado` char(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `nascimento` date DEFAULT NULL,
  `emailenfam` varchar(120) COLLATE utf8_unicode_ci DEFAULT NULL,
  `redefinir_senha` char(1) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'N',
...
) ENGINE=InnoDB AUTO_INCREMENT=143383 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=15592 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-11-23 17:29:09
